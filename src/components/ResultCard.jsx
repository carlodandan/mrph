    ...
    <div className="bg-linear-to-br from-white to-blue-50 rounded-2xl shadow-xl p-6 md:p-8 border border-gray-200">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-800">Exam Results</h3>
      ...
      {result.categoryScores && (
        <div className="mb-6">
          <h4 className="text-lg font-semibold text-gray-800 mb-3">Category Performance</h4>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{result.timeTaken}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-gray-800">{result.answersCount || 0}/{result.totalQuestions}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Performance Summary */}
      <div className="mb-8">
        <h4 className="text-lg font-semibold text-gray-800 mb-3">Performance Summary</h4>
      ...
      {hasEvaluations && (
        <div className="mb-8">
          <h4 className="text-lg font-semibold text-gray-800 mb-3">Question Review</h4>
          <div className="space-y-4">
            {result.evaluations.map((evaluation, index) => {
              ...
              return (
                <div key={evaluation.questionId || index} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                  <button
